...
import { CustomButton, FormField, Loader, DeployInstructions } from "../components";
...
const CreateCampaign = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!contract) {
      alert("No contract detected. Please deploy a CrowdFunding contract first.");
      return;
    }
    ...
    <div className="bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4">
      ...
      {!contract && (
        <div className="w-full mt-[20px]">
          <p className="font-epilogue font-semibold text-[14px] leading-[30px] text-[#fb5b5b] text-center">
      ...
      >
        ...
        <div className="flex justify-center items-center mt-[40px]">
          <CustomButton
            ...
            styles={contract ? "bg-[#1dc071]" : "bg-[#808080] cursor-not-allowed"}
            disabled={!contract}
          />
        </div>
      </form>
